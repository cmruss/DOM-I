...
newNavLinkA.textContent = "Cody";
newNavLinkB.textContent = "Russell";
...
let aboutHeader = document.querySelector(".top-content div:last-child h4");
aboutHeader.textContent = siteContent["main-content"]["about-h4"];

let aboutContent = document.querySelector(".top-content div:last-child p");
aboutContent.textContent = siteContent["main-content"]["about-content"];

let middleImg = document.getElementById("middle-img");
middleImg.setAttribute('src', siteContent["main-content"]["middle-img-src"]);

let servicesHeader = document.querySelector(".bottom-content  div:first-child h4");
servicesHeader.textContent = siteContent["main-content"]["services-h4"];

let servicesContent = document.querySelector(".bottom-content  div:first-child p");
...
let visionHeader = document.querySelector(".bottom-content  div:last-child h4");
visionHeader.textContent = siteContent["main-content"]["vision-h4"];

let visionContent = document.querySelector(".bottom-content  div:last-child p");
